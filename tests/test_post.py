...
def test_get_all_posts(authorized_client,test_posts):
    ...
    assert res.status_code==201 #Changed this from 200 for testing. Revert it back
...
@pytest.mark.parametrize("title,content,published",[
    ...
    ("favorite pizza","i love chicken pizza",False),
...
def test_delete_Post_non_existent(authorized_client,test_user2,test_posts):
...
# def test_update_Post_non_existent(authorized_client,test_user,test_posts):
#     data={
#         "title":"updated title",
#         "content":"updated content",
#         "id": test_posts[0].id
#     }
#     res=authorized_client.put(f"/posts/9999",json=data['id'])
#     assert res.status_code==403